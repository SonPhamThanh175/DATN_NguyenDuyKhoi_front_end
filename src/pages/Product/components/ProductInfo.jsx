...
function ProductInfo({ product = {} }) {
  const { name, description, salePrice, originalPrice, size, _id, images = [], rating , quantity } = product
      ...
      <div style={styles.productContainer}>
        ...
        <div style={styles.info}>
              ...
              <div style={styles.colorGrid}>
                {colorOptions.map((color, idx) => (
                  <div key={idx} style={styles.colorOption} onClick={() => handleSelectColor(color)}>
                    <img src={color || "/placeholder.svg"} alt={`Color option ${idx + 1}`} style={styles.colorImage} />
                    <div
                      style={{
                        ...styles.colorBorder,
          ...
          <div style={styles.descriptionSection}>
            ...
            <p style={styles.descriptionText}>{description || "Hiện chưa có mô tả cho sản phẩm này."}</p>
          </div>
        </div>
      </div>
